...
date: '2026-05-04'
description: >-
  A comparative inquiry into whether displaced nobles and demoted hereditary elites have outsized influence on major historical transitions.
draft: false
keywords:
  - fallen aristocrats
  - aristocracy
...
markup: goldmark
meta:
  abstract: A comparative inquiry into whether displaced nobles and demoted hereditary elites have outsized influence on major historical transitions.
  categories:
    - Political History
    - Intellectual History
    - Elite Studies
  ...
  creator:
    - Salvador Guzman
  dataset_id: fallen-aristocracy
  date: '2026-05-04'
  description: A comparative inquiry into whether displaced nobles and demoted hereditary elites have outsized influence on major historical transitions.
  edition: '1.0'
  epub-chapter-level: 2
  epub-title-page: false
  format: text/markdown
  identifier: urn:marginalia:fallen-aristocracy
  keywords:
    - fallen aristocrats
    - aristocracy
    - elite decline
  ...
  library_of_congress_classification:
    class: D13
    description: World historical analysis of elites, political transformation, and comparative social change.
    label: World history and historical sociology
  license: CC0-1.0
  number-sections: true
  publisher: Marginalia
  reference-section-title: References
  report:
    audience: general reader with interest in history and political theory
    code: ''
    collection: ''
    conversion:
      date: '2026-05-06'
      source_docx: fallen-aristocracy.docx
      tool: pandoc 3.6
    discipline: history
    domain: comparative political and intellectual history
    emphasis: elite displacement and causal claims about historical change
    focus: fallen aristocrats as agents versus structural drivers
    id: urn:marginalia:fallen-aristocracy
    intent: test the hypothesis that demoted hereditary elites disproportionately shape politics and culture after losing status
    is_report: true
    kind: comparative historical analysis
    level: ''
    ...
    population_focus: displaced hereditary elites, emigres, and former nobility
    primary_texts: []
    region: transregional
    region_focus: France, Russia, Byzantium/Italy, Japan, and Latin America
    scope: definition, mechanisms, case studies, alternative explanations, and hypothesis testing
    scope_years: 1453-20th century
    series: comparative-historical-studies
    stance: analytical
    structure: methodology plus comparative case study table and conclusion
    subdiscipline: elite studies and historical sociology
    subject: fallen aristocrats and historical change
    time_scope: comparative long-run history
    time_span: 1453-20th century
    topic: Fallen Aristocracy
    type: report
    version: 1.0.0
    year: 2026
  revision: 1.0.0
  rights: CC0-1.0
  slug: fallen-aristocracy
  status: draft
  subject:
    - Aristocracy
    - Elite decline
