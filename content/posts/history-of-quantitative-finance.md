...
date: '2026-05-04'
description: >-
  A historical and conceptual survey of quantitative finance, from early probability models through modern algorithmic and machine-learning-driven trading.
draft: false
keywords:
  - quantitative finance
  - quant trading
...
lastmod: '2026-05-04'
layout: single
linkTitle: A History of Quantitative Finance
markup: goldmark
meta:
  abstract: A historical and conceptual survey of quantitative finance, from early probability models through modern algorithmic and machine-learning-driven trading.
  categories:
    - Finance
    - Financial History
    - Quantitative Finance
  ...
  creator:
    - Salvador Guzman
  dataset_id: history-of-quantitative-finance
  date: '2026-05-04'
  description: A historical and conceptual survey of quantitative finance, from early probability models through modern algorithmic and machine-learning-driven trading.
  edition: '1.0'
  epub-chapter-level: 2
  epub-title-page: false
  format: text/markdown
  identifier: urn:marginalia:history-of-quantitative-finance
  keywords:
    - quantitative finance
    - quant trading
    - Bachelier
  ...
  library_of_congress_classification:
    class: HG4515.15
    description: Investment analysis, quantitative trading, portfolio theory, and financial market modeling.
    label: Investment analysis and quantitative finance
  license: CC0-1.0
  number-sections: true
  publisher: Marginalia
  reference-section-title: References
  report:
    audience: general financially literate reader
    code: ''
    collection: ''
    conversion:
      date: '2026-05-04'
      source_docx: quant-history.docx
      tool: pandoc 3.6
    discipline: finance
    domain: quantitative finance
    emphasis: historical development and strategic evolution
    focus: academic milestones, industry formation, crises, and AI-era trends
    id: urn:marginalia:history-of-quantitative-finance
    intent: trace the development of quantitative finance as theory, industry, and technological practice
    is_report: true
    ...
    methods:
      ...
      - literature review
      - institutional and media source review
    name: A History of Quantitative Finance
    notes: ''
    number: ''
    organization: Marginalia
    period: 1900-2026
    period_covered: 1900-2026
    population_focus: quantitative traders, hedge funds, financial theorists, and market institutions
    primary_texts: []
    region: global
    region_focus: United States and global finance
    scope: theory, firms, strategies, crises, regulation, and future directions
    scope_years: 1900-2026
    series: financial-history-studies
    stance: analytical and historical
    structure: executive summary plus chronological and thematic sections
    subdiscipline: financial history and investment analysis
    subject: history of quantitative finance
    time_scope: modern financial history
    time_span: 1900-2026
    topic: A History of Quantitative Finance
    type: report
    version: 1.0.0
    year: 2026
  revision: 1.0.0
  rights: CC0-1.0
  slug: history-of-quantitative-finance
  status: draft
  subject:
    - Quantitative finance
    - Financial history
  ...
  tags:
    ...
    - market-structure
    - machine-learning
  title: A History of Quantitative Finance
  toc: true
  toc-depth: 3
  toc-title: Contents
  type: report
